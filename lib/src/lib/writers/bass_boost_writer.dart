...
class BassBoostWriter extends BinaryWriter {
  ...
  BassBoostWriter(this.frequency, {double bassGain = 20.0}) {
    ...
    var a = exp(log(10.0) * bassGain / 40);
  ...
  void writeSample(int sample) {
    var inp = sample / Definitions.signalValue;
    var out =
    ...
    var v = (out * Definitions.signalValue).round();
    super.writeSample(v);
  }
}
